...
每句话都是由词组成的，而词又是由字符组成的。每个对象都是可打印的它们可以在它们之前或之后打印一些东西比如句子总是以句号结尾单词总是有空格在它之前
...
Taking our sentence example from above. 
Here we have the base class and different printable types
